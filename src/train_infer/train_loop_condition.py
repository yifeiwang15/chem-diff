...
class TrainLoop:
    def __init__(
        ...
        *,
        ...
        # if we use scaffold condition
        self.scaffold_encoder = None
        self.load_scaffold_encoder()
    ...
    def load_scaffold_encoder(self):
        self.scaffold_encoder = SmilesModel.SmilesEncoder(
            device=th.device("cuda:0" if th.cuda.is_available() else "cpu"))
        state_dict_smiles = th.load('src/modeling/pretrained_encoder/PretrainWeights/smiles_model_weights.pth')
        self.scaffold_encoder.load_state_dict(state_dict_smiles, strict=False)
        self.scaffold_encoder.eval()
